    ...
    <Link href={`/product/${product.slug}`} className="group block h-full">
      ...
      >
        ...
        <div className="flex flex-col flex-1 p-2 md:p-3">
          <h3 className="line-clamp-2 text-xs font-medium text-text-primary md:text-sm flex-1">
            {product.title}
          </h3>

          <div className="mt-1 flex items-baseline gap-1.5 md:mt-2">
          ...
          <button
            ...
            disabled={!inStock}
            className={cn(
              'mt-2 flex w-full items-center justify-center gap-1 rounded-lg py-1.5 text-xs font-semibold transition-all duration-200 md:mt-3 md:py-2 md:text-sm flex-shrink-0',
              inStock
